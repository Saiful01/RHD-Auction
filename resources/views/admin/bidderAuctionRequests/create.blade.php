        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.bidderAuctionRequest.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.bidder-auction-requests.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('pay_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pay_amount" id="pay_amount" value="{{ old('pay_amount', '') }}" step="0.0000001">
