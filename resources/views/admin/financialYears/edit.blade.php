                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.financial-years.update", [$financialYear->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('year') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="year" id="year" value="{{ old('year', $financialYear->year) }}" required>
                            @if($errors->has('year'))
                        ...
                        <div class="form-group {{ $errors->has('start_date') ? 'has-error' : '' }}">
                            <label for="start_date">{{ trans('cruds.financialYear.fields.start_date') }}</label>
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $financialYear->start_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('end_date') ? 'has-error' : '' }}">
                            <label for="end_date">{{ trans('cruds.financialYear.fields.end_date') }}</label>
                            <input class="form-control date" type="text" name="end_date" id="end_date" value="{{ old('end_date', $financialYear->end_date) }}">
