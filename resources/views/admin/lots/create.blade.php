        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.lot.title_singular') }}
                </div>

                <div class="panel-body">
                    <form method="POST" action="{{ route('admin.lots.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('road') ? 'has-error' : '' }}">
                                    ...
                                    <span class="help-block">
                                        {{ trans('cruds.lot.fields.road_helper') }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('package') ? 'has-error' : '' }}">
                                    ...
                                    @endif
                                    <span class="help-block">
                                        {{ trans('cruds.lot.fields.package_helper') }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            @endif
                            <span class="help-block">
                                {{ trans('cruds.lot.fields.name_helper') }}
                            </span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('details') ? 'has-error' : '' }}">
                            ...
                            @endif
                            <span class="help-block">
                                {{ trans('cruds.lot.fields.details_helper') }}
                            </span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('location') ? 'has-error' : '' }}">
                            ...
                            @endif
                            <span class="help-block">
                                {{ trans('cruds.lot.fields.location_helper') }}
                            </span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('tree_description') ? 'has-error' : '' }}">
                            ...
                            @if($errors->has('tree_description'))
                                <span class="help-block" role="alert">
                                    {{ $errors->first('tree_description') }}
                                </span>
                            @endif
                            <span class="help-block">
                                {{ trans('cruds.lot.fields.tree_description_helper') }}
                            </span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('comment') ? 'has-error' : '' }}">
                            ...
                            @endif
                            <span class="help-block">
                                {{ trans('cruds.lot.fields.comment_helper') }}
                            </span>
                        </div>
