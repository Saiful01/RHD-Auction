                    ...
                    <form method="POST" action="{{ route("admin.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('cadre_name') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Employee::CADRE_NAME_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="cadre_name_{{ $key }}" name="cadre_name" value="{{ $key }}" {{ old('cadre_name', $employee->cadre_name) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('charge_type') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Employee::CHARGE_TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="charge_type_{{ $key }}" name="charge_type" value="{{ $key }}" {{ old('charge_type', $employee->charge_type) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('post_type') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Employee::POST_TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="post_type_{{ $key }}" name="post_type" value="{{ $key }}" {{ old('post_type', $employee->post_type) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('job_status') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Employee::JOB_STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="job_status_{{ $key }}" name="job_status" value="{{ $key }}" {{ old('job_status', $employee->job_status) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('office') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="office_id" id="office_id" required>
                                @foreach($offices as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('office_id') ? old('office_id') : $employee->office->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('name_en') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name_en" id="name_en" value="{{ old('name_en', $employee->name_en) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('name_bn') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name_bn" id="name_bn" value="{{ old('name_bn', $employee->name_bn) }}">
                        ...
                        <div class="form-group {{ $errors->has('personnel') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="personnel" id="personnel" value="{{ old('personnel', $employee->personnel) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('gradation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="gradation" id="gradation" value="{{ old('gradation', $employee->gradation) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('grade') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="grade" id="grade" value="{{ old('grade', $employee->grade) }}">
                            @if($errors->has('grade'))
                        ...
                        <div class="form-group {{ $errors->has('bcs_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="bcs_no" id="bcs_no" value="{{ old('bcs_no', $employee->bcs_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('passing_year') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="passing_year" id="passing_year" value="{{ old('passing_year', $employee->passing_year) }}">
                        ...
                        <div class="form-group {{ $errors->has('birth_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="birth_date" id="birth_date" value="{{ old('birth_date', $employee->birth_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('date_of_retirement') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="date_of_retirement" id="date_of_retirement" value="{{ old('date_of_retirement', $employee->date_of_retirement) }}">
                        ...
                        <div class="form-group {{ $errors->has('phone_office') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_office" id="phone_office" value="{{ old('phone_office', $employee->phone_office) }}">
                        ...
                        <div class="form-group {{ $errors->has('phone_personal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_personal" id="phone_personal" value="{{ old('phone_personal', $employee->phone_personal) }}">
                        ...
                        <div class="form-group {{ $errors->has('email_office') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email_office" id="email_office" value="{{ old('email_office', $employee->email_office) }}">
                        ...
                        <div class="form-group {{ $errors->has('email_personal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email_personal" id="email_personal" value="{{ old('email_personal', $employee->email_personal) }}">
