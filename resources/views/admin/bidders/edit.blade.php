        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.bidders.update", [$bidder->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            <label class="required" for="name">{{ trans('cruds.bidder.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $bidder->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $bidder->email) }}">
                            @if($errors->has('email'))
                        ...
                        <div class="form-group {{ $errors->has('nid_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nid_no" id="nid_no" value="{{ old('nid_no', $bidder->nid_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('tin_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tin_no" id="tin_no" value="{{ old('tin_no', $bidder->tin_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('bin_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="bin_no" id="bin_no" value="{{ old('bin_no', $bidder->bin_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $bidder->address) }}">
                        ...
                        <div class="form-group {{ $errors->has('nid_file') ? 'has-error' : '' }}">
                        ...
                        <div class="form-group {{ $errors->has('tin_file') ? 'has-error' : '' }}">
                        ...
                        <div class="form-group {{ $errors->has('bin_file') ? 'has-error' : '' }}">
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Bidder::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $bidder->status) === (string) $key ? 'checked' : '' }}>
