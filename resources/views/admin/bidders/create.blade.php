        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.bidder.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.bidders.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('tin_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tin_no" id="tin_no" value="{{ old('tin_no', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('bin_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="bin_no" id="bin_no" value="{{ old('bin_no', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Bidder::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', '0') === (string) $key ? 'checked' : '' }}>
