                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.designations.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('designation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="designation" id="designation" value="{{ old('designation', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('designation_en') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="designation_en" id="designation_en" value="{{ old('designation_en', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('designation_bn') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="designation_bn" id="designation_bn" value="{{ old('designation_bn', '') }}">
