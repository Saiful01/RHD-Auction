                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.auctions.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('lots') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="lots[]" id="lots" multiple required>
                                @foreach($lots as $id => $lot)
                                    <option value="{{ $id }}" {{ in_array($id, old('lots', [])) ? 'selected' : '' }}>{{ $lot }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('lots'))
                        ...
                        <div class="form-group {{ $errors->has('memo_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="memo_no" id="memo_no" value="{{ old('memo_no', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('announcement_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="announcement_no" id="announcement_no" value="{{ old('announcement_no', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('auction_start_time') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="auction_start_time" id="auction_start_time" value="{{ old('auction_start_time') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('auction_end_time') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="auction_end_time" id="auction_end_time" value="{{ old('auction_end_time') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('tender_visible_start_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="tender_visible_start_date" id="tender_visible_start_date" value="{{ old('tender_visible_start_date') }}">
                        ...
                        <div class="form-group {{ $errors->has('tender_visible_end_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="tender_visible_end_date" id="tender_visible_end_date" value="{{ old('tender_visible_end_date') }}">
                        ...
                        <div class="form-group {{ $errors->has('tender_sale_start_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="tender_sale_start_date" id="tender_sale_start_date" value="{{ old('tender_sale_start_date') }}">
                        ...
                        <div class="form-group {{ $errors->has('tender_sale_end_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="tender_sale_end_date" id="tender_sale_end_date" value="{{ old('tender_sale_end_date') }}">
                        ...
                        <div class="form-group {{ $errors->has('deadline_for_tree_removal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="deadline_for_tree_removal" id="deadline_for_tree_removal" value="{{ old('deadline_for_tree_removal', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('estimate_value_percentage') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="estimate_value_percentage" id="estimate_value_percentage" value="{{ old('estimate_value_percentage', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('base_value_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="base_value_amount" id="base_value_amount" value="{{ old('base_value_amount', '') }}" step="0.00001" required>
                        ...
                        <div class="form-group {{ $errors->has('min_bid_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="min_bid_amount" id="min_bid_amount" value="{{ old('min_bid_amount', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('vat') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="vat" id="vat" value="{{ old('vat', '') }}" step="1">
                            @if($errors->has('vat'))
                        ...
                        <div class="form-group {{ $errors->has('tax') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tax" id="tax" value="{{ old('tax', '') }}" step="1">
                            @if($errors->has('tax'))
