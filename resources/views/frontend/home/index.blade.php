...
@section('content')
    ...
    <div class="home1-banner-section mb-110">
        <div class="banner-wrapper" style="background-image: linear-gradient(180deg, rgba(11, 12, 12, 0.65) 0%, rgba(11, 12, 12, 0.65) 100%), url(assets/img/banner.jpg);">
            <div class="container">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="auction-card">
                                        <div class="auction-card-img-wrap">
                                            <a href="auction-details.html" class="card-img">
                                        ...
                                        <div class="auction-card-content">
                                            <h6><a href="auction-details.html">Zenith auto elevating driving your experience</a></h6>
                                            ...
                                            <div class="author-and-btn-area">
                                                <a href="store-details.html" class="author-area">
                                                ...
                                                <a href="auction-details.html" class="bid-btn">
                                                    Bid Now
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="auction-card">
                                        ...
                                        <div class="auction-card-content">
                                            <h6><a href="auction-details.html">Heritage had curating watch time
                                                    treasures.</a></h6>
                                            <div class="price-and-code-area">
                                                <div class="price">
                                                    <span>Current Bid at:</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="auction-card">
                                        ...
                                        <div class="auction-card-content">
                                            <h6><a href="auction-details.html">Canvas code redefining art in the digital
                                                    realm.</a></h6>
                                            <div class="price-and-code-area">
                                                <div class="price">
                                                    <span>Current Bid at:</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="auction-card">
                                        ...
                                        <div class="auction-card-content">
                                            <h6><a href="auction-details.html">Nomism on nexus connecting collectors to coins.</a></h6>
                                            <div class="price-and-code-area">
                                                <div class="price">
                                                    <span>Current Bid at:</span>
                                                    <strong>$5,635</strong>
                                ...
                                <div class="swiper-slide">
                                    <div class="auction-card">
                                        ...
                                        <div class="auction-card-content">
                                            <h6><a href="auction-details.html">Vintage valor embracing then elegance of eras past.</a></h6>
                                            <div class="price-and-code-area">
                                                <div class="price">
                                                    <span>Current Bid at:</span>
                                                    <strong>$2,898</strong>
                                ...
                                <div class="swiper-slide">
                                    <div class="auction-card">
                                        ...
                                        <div class="auction-card-content">
                                            <h6><a href="auction-details.html">Canvas & culture brush withn elegance auction.</a></h6>
                                            <div class="price-and-code-area">
                                                <div class="price">
                                                    <span>Current Bid at:</span>
                                                    <strong>$9,458</strong>
                                ...
                                <div class="swiper-slide">
                                    <div class="auction-card">
                                        ...
                                        <div class="auction-card-content">
                                            <h6><a href="auction-details.html">Nostalgian hookup memories reside in every piece.</a></h6>
                                            <div class="price-and-code-area">
                                                <div class="price">
                                                    <span>Current Bid at:</span>
                                                    <strong>$8,687</strong>
    ...
    <!-- Start Auction Category section -->
    <div class="home1-category-section mb-110">
        <div class="category-wrapper">
            <div class="container">
                ...
                <div class="category-slider-area wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="swiper home1-category-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="category-card">
                                            <a href="auction-sidebar.html" class="category-img">
                                                <img src="assets/img/home1/category-img1.jpg" alt="">
                                            </a>
                                            <div class="category-content">
                                                <h5><a href="auction-sidebar.html">Automotive</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="category-card">
                                            ...
                                            <div class="category-content">
                                                <h5><a href="auction-sidebar.html">Antiques</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="category-card">
                                            ...
                                            <div class="category-content">
                                                <h5><a href="auction-sidebar.html">Digital Art</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="category-card">
                                            ...
                                            <div class="category-content">
                                                <h5><a href="auction-sidebar.html">Books & Comic</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="category-card">
                                            ...
                                            <div class="category-content">
                                                <h5><a href="auction-sidebar.html">Old Coin</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="category-card">
                                            ...
                                            <div class="category-content">
                                                <h5><a href="auction-sidebar.html">Gadget</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="category-card">
                                            ...
                                            <div class="category-content">
                                                <h5><a href="auction-sidebar.html">Jewelry</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="category-card">
                                            ...
                                            <div class="category-content">
                                                <h5><a href="auction-sidebar.html">Real Estate</a></h5>
                                                <span>45,680 Item</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="category-card">
                                            ...
                                            <div class="category-content">
                                                <h5><a href="auction-sidebar.html">Fashion</a></h5>
                                                <span>41,250 Item</span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <!-- End Auction Category section -->

    <!-- Start Latest Auction section -->
    <div class="latest-auction-section mb-110">
        <div class="container">
            <div class="row mb-60">
                <div class="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
                    ...
                    <a class="view-button wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms" href="auction-grid.html">
                        View All Auction
                        <svg viewBox="0 0 13 20">
                            <polyline points="0.5 19.5 3 19.5 12.5 10 3 0.5"></polyline>
                        </svg>
            ...
            <div class="row g-4">
                <div class="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="auction-card">
                        ...
                        <div class="auction-card-content">
                            <h6><a href="auction-details.html">Vintage valor embracing then elegance of eras past.</a>
                            </h6>
                            <div class="price-and-code-area">
                                <div class="price">
                                    <span>Current Bid at:</span>
                    ...
                    <div class="auction-card">
                        ...
                        <div class="auction-card-content">
                            ...
                            <div class="author-and-btn-area">
                                ...
                                <a href="auction-details2.html" class="bid-btn">
                                    Notify Me
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="auction-card">
                        ...
                        <div class="auction-card-content">
                            <h6><a href="auction-details.html">Nostalgian hookup memories reside in every piece.</a>
                            </h6>
                            <div class="price-and-code-area">
                                <div class="price">
                                    <span>Current Bid at:</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div class="auction-card">
                        ...
                        <div class="auction-card-content">
                            <h6><a href="auction-details.html">Titan motors built to conquer every milen.</a></h6>
                            <div class="price-and-code-area">
                                <div class="price">
                                    <span>Current Bid at:</span>
                                    <strong>$6,367</strong>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div class="auction-card">
                        ...
                        <div class="auction-card-content">
                            <h6><a href="auction-details.html">Electro edge redefining times possibilities gadget.</a>
                            </h6>
                            <div class="price-and-code-area">
                                <div class="price">
                                    <span>Current Bid at:</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="auction-card">
                        ...
                        <div class="auction-card-content">
                            <h6><a href="auction-details.html">Coin crest cresting the peak of numismatic.</a></h6>
                            <div class="price-and-code-area">
                                <div class="price">
                                    <span>Current Bid at:</span>
                                    <strong>$5,578</strong>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="auction-card">
                        ...
                        <div class="auction-card-content">
                            <h6><a href="auction-details.html">Pixela prodigy inspiring pixels time creators one.</a>
                            </h6>
                            <div class="price-and-code-area">
                                <div class="price">
                                    <span>Current Bid at:</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="auction-card">
                        ...
                        <div class="auction-card-content">
                            <h6><a href="auction-details.html">Gizmo galaxy your universent of cutting edge tech.</a>
                            </h6>
                            <div class="price-and-code-area">
                                <div class="price">
                                    <span>Current Bid at:</span>
    ...
    <!-- End Latest Auction section -->

    <!-- Start Banner2 section -->
    <div class="home1-banner2-section mb-110">
        <div class="banner2-wrapper">
            <div class="row g-xl-3 gy-5">
                <div class="col-xl-8">
                    <div class="swiper home1-banner2-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="banner2-left-area" style="background-image: url(assets/img/home1/home1-banne2-slider-bg1.png), linear-gradient(180deg, rgba(247, 234, 212, 1) 0%, rgba(247, 234, 212, 1) 100%);">
                                    <div class="batch wow animate swing" data-wow-delay="200ms" data-wow-duration="1500ms">
                                    ...
                                    <div class="banner2-left-content">
                                        ...
                                        <a class="primary-btn btn-hover black-bg" href="auction-details.html">
                                            Bid Now
                                            <span></span>
                                        </a>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="banner2-left-area" style="background-image: url(assets/img/home1/home1-banne2-slider-bg2.png), linear-gradient(180deg, rgba(238, 243, 214, 1) 0%, rgba(238, 243, 214, 1) 100%);">
                                    <div class="batch wow animate swing" data-wow-delay="200ms" data-wow-duration="1500ms">
                                        <span>HURRY <br> UP!</span>
                                    </div>
                                    <div class="banner2-left-content">
                            ...
                            <div class="swiper-slide">
                                <div class="banner2-left-area" style="background-image: url(assets/img/home1/home1-banne2-slider-bg3.png), linear-gradient(180deg, rgba(171, 208, 167, 1) 0%, rgba(171, 208, 167, 1) 100%);">
                                    <div class="batch wow animate swing" data-wow-delay="200ms" data-wow-duration="1500ms">
                                        <span>HURRY <br> UP!</span>
                                    </div>
                                    <div class="banner2-left-content">
    ...
    <div class="home1-about-section mb-110">
        <div class="container">
            <div class="about-top-area mb-40">
                <div class="row g-xxl-4 g-lg-3 gy-4">
                    <div class="col-xxl-6 col-xl-5">
                        <div class="about-top-img">
                            <img src="assets/img/home1/home1-about-img1.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-7">
                        <div class="about-content">
                            <div class="section-title wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <h2>Get In <span>Know</span></h2>
                                <p>Welcome to Zenfy, where digital innovation meets strategic excellence. As a dynamic
                                    force in the realm of digital marketing, we are dedicated to propelling businesses
                                    into the spotlight of online success with us for this example .</p>
                            </div>
                            <ul class="wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <li>
                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M16 8.00024C16 8.68221 15.1622 9.24431 14.9943 9.87301C14.8212 10.523 15.2594 11.4288 14.9304 11.9975C14.5961 12.5756 13.5904 12.6449 13.1216 13.1137C12.6527 13.5826 12.5834 14.5883 12.0053 14.9226C11.4366 15.2516 10.5308 14.8134 9.88083 14.9865C9.25213 15.1544 8.69003 15.9922 8.00805 15.9922C7.32607 15.9922 6.76397 15.1544 6.13527 14.9865C5.48526 14.8134 4.57951 15.2516 4.01075 14.9226C3.43267 14.5883 3.3634 13.5826 2.89454 13.1137C2.42568 12.6449 1.42003 12.5756 1.0857 11.9975C0.756699 11.4288 1.19492 10.523 1.02177 9.87301C0.853935 9.24431 0.0161133 8.68221 0.0161133 8.00024C0.0161133 7.31826 0.853935 6.75616 1.02177 6.12746C1.19492 5.47745 0.756699 4.5717 1.0857 4.00294C1.42003 3.42485 2.42568 3.35559 2.89454 2.88673C3.3634 2.41787 3.43267 1.41222 4.01075 1.07789C4.57951 0.748887 5.48526 1.18711 6.13527 1.01395C6.76397 0.846122 7.32607 0.00830078 8.00805 0.00830078C8.69003 0.00830078 9.25213 0.846122 9.88083 1.01395C10.5308 1.18711 11.4366 0.748887 12.0053 1.07789C12.5834 1.41222 12.6527 2.41787 13.1216 2.88673C13.5904 3.35559 14.5961 3.42485 14.9304 4.00294C15.2594 4.5717 14.8212 5.47745 14.9943 6.12746C15.1622 6.75616 16 7.31826 16 8.00024Z" />
                                        <path
                                            d="M10.3177 5.61854L7.27542 8.6608L5.69835 7.08506C5.53387 6.92068 5.31085 6.82833 5.07831 6.82833C4.84577 6.82833 4.62274 6.92068 4.45827 7.08506C4.29388 7.24954 4.20154 7.47256 4.20154 7.7051C4.20154 7.93764 4.29388 8.16067 4.45827 8.32514L6.6707 10.5376C6.83079 10.6975 7.04782 10.7873 7.27409 10.7873C7.50037 10.7873 7.71739 10.6975 7.87748 10.5376L11.5564 6.85862C11.7208 6.69415 11.8132 6.47112 11.8132 6.23858C11.8132 6.00604 11.7208 5.78302 11.5564 5.61854C11.4751 5.53715 11.3786 5.47259 11.2723 5.42854C11.166 5.38449 11.0521 5.36182 10.9371 5.36182C10.822 5.36182 10.7081 5.38449 10.6018 5.42854C10.4955 5.47259 10.399 5.53715 10.3177 5.61854Z"
                                            fill="#FFFCEE" />
                                    </svg>
                            ...
                            <a class="primary-btn btn-hover wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" href="about.html">
                                About us More
                                <svg width="11" height="11" viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M10.0266 9.33856L0.689022 0.000487831L-3.01181e-08 0.68951L9.33807 10.0271L2.88172 10.0271L2.88172 11.001L11.0005 11.001L11.0005 2.88221L10.0266 2.88221L10.0266 9.33856Z">
            ...
            <div class="about-bottom-area">
                <div class="row align-items-lg-center align-items-start gy-4">
                    <div class="col-xxl-6 col-xl-5 order-xl-1 order-2">
                        <div class="about-author-content wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <p>"I work with Alguneb Johnl on many projects, he always told agonaex my expectations with
                                his quality work and fastestopa tope services smooth and simple communication." </p>
                            <h4>Leslie Alexander</h4>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-7 order-xl-2 order-1">
                        <div class="about-bottom-img">
                            <img src="assets/img/home1/home1-about-img2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Start Home1 Upcoming Auction section -->
    <div class="home1-upcoming-auction-section mb-110">
        <div class="upcoming-auction-wrapper">
            <div class="row mb-60 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div class="section-title">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="upcoming-auction-nav">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link active" id="all-tab" data-bs-toggle="tab" data-bs-target="#all" type="button" role="tab" aria-controls="all" aria-selected="true">Show all</button>
                                ...
                                <button class="nav-link" id="antiques-tab" data-bs-toggle="tab" data-bs-target="#antiques" type="button" role="tab" aria-controls="antiques" aria-selected="false">Antiques</button>
                                <button class="nav-link" id="digital-art-tab" data-bs-toggle="tab" data-bs-target="#digital-art" type="button" role="tab" aria-controls="digital-art" aria-selected="false">Digital Art</button>
                                <button class="nav-link" id="books-comics-tab" data-bs-toggle="tab" data-bs-target="#books-comics" type="button" role="tab" aria-controls="books-comics" aria-selected="false">Books & Comics</button>
                            </div>
                        </nav>
                    </div>
                    <div class="upcoming-auction-tab-area">
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab" tabindex="0">
                                <div class="upcoming-auction-tab-wrap">
                                    <div class="upcoming-auction-banner">
                            ...
                            <div class="tab-pane fade" id="automotive" role="tabpanel" aria-labelledby="automotive-tab" tabindex="0">
                                <div class="upcoming-auction-tab-wrap">
                                    <div class="upcoming-auction-banner">
                                        <img src="assets/img/home1/upcoming-auction-banner-img.jpg" alt="">
                                    </div>
                            ...
                            <div class="tab-pane fade" id="antiques" role="tabpanel" aria-labelledby="antiques-tab" tabindex="0">
                                <div class="upcoming-auction-tab-wrap">
                                    <div class="upcoming-auction-banner">
                                        <img src="assets/img/home1/upcoming-auction-banner-img.jpg" alt="">
                                    </div>
                            ...
                            <div class="tab-pane fade" id="digital-art" role="tabpanel" aria-labelledby="digital-art-tab" tabindex="0">
                                <div class="upcoming-auction-tab-wrap">
                                    <div class="upcoming-auction-banner">
                                        <img src="assets/img/home1/upcoming-auction-banner-img.jpg" alt="">
                                    </div>
                            ...
                            <div class="tab-pane fade" id="books-comics" role="tabpanel" aria-labelledby="books-comics-tab" tabindex="0">
                                <div class="upcoming-auction-tab-wrap">
                                    <div class="upcoming-auction-banner">
                                        <img src="assets/img/home1/upcoming-auction-banner-img.jpg" alt="">
                                    </div>
    ...
    <!-- End Home1 Upcoming Auction section -->

    <!-- Start Home1 Process section -->
    <div class="home1-process-section mb-110">
        <div class="row mb-60 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div class="col-lg-12">
        ...
        <div class="process-wrapper">
            <img src="assets/img/home1/icon/home1-process-bg-vector.svg" alt="" class="bg-vector">
            <div class="row g-4">
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="process-card-wrap d-xl-flex justify-content-start">
                        <div class="process-card arrow">
                            <div class="process-card-top-area">
                                <div class="icon">
                                    <svg width="51" height="60" viewBox="0 0 51 60" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M29.0466 4.84593H30.0708C30.2565 4.84247 30.4334 4.7663 30.5634 4.63378C30.6935 4.50127 30.7664 4.323 30.7664 4.13732C30.7664 3.95164 30.6935 3.77337 30.5634 3.64086C30.4334 3.50834 30.2565 3.43217 30.0708 3.42871H29.0466C28.8609 3.43217 28.6841 3.50834 28.554 3.64086C28.4239 3.77337 28.351 3.95164 28.351 4.13732C28.351 4.323 28.4239 4.50127 28.554 4.63378C28.6841 4.7663 28.8609 4.84247 29.0466 4.84593ZM14.2039 4.84593H25.4221C25.6077 4.84247 25.7846 4.7663 25.9147 4.63378C26.0447 4.50127 26.1176 4.323 26.1176 4.13732C26.1176 3.95164 26.0447 3.77337 25.9147 3.64086C25.7846 3.50834 25.6077 3.43217 25.4221 3.42871H14.2039C14.0159 3.42878 13.8357 3.50345 13.7029 3.63633C13.57 3.7692 13.4953 3.9494 13.4952 4.13732C13.4953 4.32523 13.57 4.50543 13.7029 4.63831C13.8357 4.77118 14.0159 4.84586 14.2039 4.84593ZM22.1386 52.0248C20.7779 52.0248 19.663 53.1302 19.663 54.5004C19.663 55.8611 20.7779 56.9666 22.1386 56.9666C23.4992 56.9666 24.6047 55.8611 24.6047 54.5004C24.6047 53.1303 23.4992 52.0248 22.1386 52.0248ZM35.2289 32.7402H9.04588C8.86023 32.7437 8.68335 32.8199 8.55328 32.9524C8.42321 33.0849 8.35034 33.2632 8.35034 33.4488C8.35034 33.6345 8.42321 33.8128 8.55328 33.9453C8.68335 34.0778 8.86023 34.154 9.04588 34.1574H35.2289C35.4146 34.154 35.5915 34.0778 35.7215 33.9453C35.8516 33.8128 35.9245 33.6345 35.9245 33.4488C35.9245 33.2632 35.8516 33.0849 35.7215 32.9524C35.5915 32.8199 35.4146 32.7437 35.2289 32.7402ZM35.2289 39.2381H9.04588C8.86023 39.2416 8.68335 39.3177 8.55328 39.4502C8.42321 39.5828 8.35034 39.761
                                    </svg>
                                </div>
                                <div class="number">
                                    <span>STEP 01</span>
                            ...
                            <div class="process-card-content">
                                ...
                                <ul>
                                    ...
                                    <li><strong>03.</strong> Such As Identification</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="process-card-wrap d-xl-flex justify-content-center">
                        <div class="process-card two">
                            <div class="process-card-top-area">
                                <div class="icon">
                                    <svg width="58" height="60" viewBox="0 0 58 60" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M15.4414 18.8086C15.9219 18.8086 16.3203 18.4219 16.3203 17.9297V5.77734C16.3203 3.55078 18.125 1.74609 20.3516 1.74609H29.0234C29.5039 1.74609 29.9023 1.35938 29.9023 0.867188C29.9023 0.375 29.4922 0 29.0117 0H20.3398C17.1523 0 14.5625 2.58984 14.5625 5.77734V17.9297C14.5625 18.4102 14.9609 18.8086 15.4414 18.8086Z"/>
                                        <path
                                            d="M25.1211 5.95312C24.4648 5.95312 23.914 5.46094 23.8437 4.80469L23.8203 4.62891C23.75 3.99609 23.2226 3.51562 22.5781 3.51562H20.3398C19.0859 3.51562 18.0664 4.53516 18.0664 5.78906V16.2422C18.0664 16.7227 18.4531 17.1211 18.9453 17.1211C19.4258 17.1211 19.8242 16.7344 19.8242 16.2422V5.77734C19.8242 5.48438 20.0586 5.25 20.3515 5.25H22.1562C22.4375 6.65625 23.6679 7.69922 25.1328 7.69922H27.7109C28.1914 7.69922 28.5898 7.3125 28.5898 6.82031C28.5898 6.32812 28.2031 5.94141 27.7109 5.94141C27.7109 5.95312 25.1211 5.95312 25.1211 5.95312ZM23.1992 20.3672C22.4492 19.3945 21.3125 18.8203 20.082 18.7852C18.8515 18.75 17.6914 19.2656 16.8828 20.2031L12.4648 25.3477C12.1484 25.7109 12.1953 26.2617 12.5586 26.5781C12.9219 26.8945 13.4726 26.8477 13.789 26.4844L18.207 21.3398C18.664 20.8125 19.332 20.5195 20.0234 20.5312C20.7265 20.5547 21.3711 20.8828 21.7929 21.4336C22.414 22.2305 22.4375 23.332 21.8633 24.1641L16.4726 31.9453C16.1211 32.4492 16.1094 33.1055 16.4375 33.6211L18.7344 37.207C22.0742 42.4219 21.7461 49.1953 17.914 54.0703L14.375 58.5703C14.0703 58.9453 14.1406 59.4961 14.5273 59.8008C14.6914 59.9297 14.8789 59.9883 15.0664 59.9883C15.3242 59.9883 15.582 59.8711 15.7578 59.6484L19.2969 55.1484C23.5859 49.6992 23.9492 42.1055 20.2109 36.2578L17.9961 32.8008L23.3047 25.1484C24.3359 23.707 24.289 21.7852 23.1992 20.3672ZM11.2578 28.0898C10.8945 27.7734 10.332 27.8203 10.0273 28.1836L9.34763 28.9688C6.4531 32.3438 4.69529 36.6328 4.3906 41.0625L4.05076 46.0898L0.38279 50.0156C0.0546649 50.3672 0.0663836 50.918 0.429665 51.2578C0.593727 51.4102 0.816384 51.4922 1.02732 51.4922C1.2617 51.4922 1.49607 51.3984 1.67
 36.5234 13.9102C37.1094 13.9102 38.2813 13.8984 38.668 13.8984C40.2031 13.8984 41.4805 12.6445 41.5039 11.1094C41.5156 10.3594 41.2344 9.64453 40.6953 9.09375C40.6016 9 40.5078 8.91797 40.4141 8.84766C40.7305 8.41406 40.8828 7.875 40.8594 7.3125ZM38.2578 6.63281C38.7031 6.63281 39.0898 6.97266 39.1016 7.39453C39.1133 7.61719 39.0312 7.82812 38.8789 7.99219C38.7266 8.15625 38.5156 8.23828 38.293 8.23828H37.0508V6.63281H38.2578ZM38.6797 12.1641H37.0625V9.99609H38.6211C38.9258 9.99609 39.2305 10.125 39.4531 10.3477C39.6641 10.5586 39.7695 10.8281 39.7695 11.1094C39.7578 11.6836 39.2656 12.1641 38.6797 12.1641Z"/>
                                    </svg>
                                </div>
                                <div class="number">
                                    <span>STEP 02</span>
                            ...
                            <div class="process-card-content">
                                ...
                                <ul>
                                    ...
                                    <li><strong>03.</strong> Choose Your Final Auction</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="process-card three">
                            <div class="process-card-top-area">
                                <div class="icon">
                                    <svg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M57 0H3C2.20435 0 1.44129 0.31607 0.87868 0.87868C0.31607 1.44129 0 2.20435 0 3L0 44C0 44.7957 0.31607 45.5587 0.87868 46.1213C1.44129 46.6839 2.20435 47 3 47H20V51C18.1441 51.0021 16.3649 51.7403 15.0526 53.0526C13.7403 54.3649 13.0021 56.1441 13 58C13 58.5304 13.2107 59.0391 13.5858 59.4142C13.9609 59.7893 14.4696 60 15 60H45C45.5304 60 46.0391 59.7893 46.4142 59.4142C46.7893 59.0391 47 58.5304 47 58C46.9979 56.1441 46.2597 54.3649 44.9474 53.0526C43.6351 51.7403 41.8559 51.0021 40 51V47H57C57.7957 47 58.5587 46.6839 59.1213 46.1213C59.6839 45.5587 60 44.7957 60 44V3C60 2.20435 59.6839 1.44129 59.1213 0.87868C58.5587 0.31607 57.7957 0 57 0ZM45 58H15C15.0016 56.6744 15.5289 55.4036 16.4662 54.4662C17.4036 53.5289 18.6744 53.0016 20 53H40C41.3255 53.0019 42.5962 53.5292 43.5335 54.4665C44.4708 55.4038 44.9981 56.6745 45 58ZM38 51H22V47H38V51ZM57 45H3C2.73478 45 2.48043 44.8946 2.29289 44.7071C2.10536 44.5196 2 44.2652 2 44V39H36C36.2652 39 36.5196 38.8946 36.7071 38.7071C36.8946 38.5196 37 38.2652 37 38C37 37.7348 36.8946 37.4804 36.7071 37.2929C36.5196 37.1054 36.2652 37 36 37H2V3C2 2.73478 2.10536 2.48043 2.29289 2.29289C2.48043 2.10536 2.73478 2 3 2H57C57.2652 2 57.5196 2.10536 57.7071 2.29289C57.8946 2.48043 58 2.73478 58 3V37H56C55.7348 37 55.4804 37.1054 55.2929 37.2929C55.1054 37.4804 55 37.7348 55 38C55 38.2652 55.1054 38.5196 55.2929 38.7071C55.4804 38.8946 55.7348 39 56 39H58V44C58 44.2652 57.8946 44.5196 57.7071 44.7071C57.5196 44.8946 57.2652 45 57 45Z"/>
                                        <path
                                    </svg>
                                </div>
                                <div class="number">
                                    <span>STEP 03</span>
                            ...
                            <div class="process-card-content">
                                ...
                                <ul>
                                    ...
                                    <li><strong>03.</strong> Keep Your Eyes On The Bid</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="process-card-wrap d-xl-flex justify-content-end">
                        <div class="process-card four">
                            <div class="process-card-top-area">
                                <div class="icon">
                                    <svg width="52" height="60" viewBox="0 0 52 60" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M34.7752 4.73132C34.6752 4.66108 34.5617 4.61249 34.4419 4.58865C34.3221 4.56481 34.1986 4.56625 34.0794 4.59288C33.9601 4.61951 33.8478 4.67074 33.7495 4.74329C33.6512 4.81584 33.5691 4.90812 33.5085 5.01421C33.5027 5.02476 33.4953 5.03437 33.4888 5.04398C33.2069 5.44687 32.6498 5.54472 32.247 5.26323C31.8491 4.98491 31.3013 5.08101 31.0229 5.47886L29.742 7.30851C29.6498 7.44018 29.5955 7.59462 29.5849 7.75502C29.5743 7.91542 29.608 8.07565 29.6821 8.21828C29.7563 8.3609 29.8681 8.48047 30.0055 8.56398C30.1428 8.64748 30.3004 8.69173 30.4612 8.69191C30.6026 8.69206 30.742 8.65805 30.8675 8.59275C30.9929 8.52746 31.1007 8.43283 31.1818 8.31691L32.0446 7.08421C32.8549 7.30991 33.7352 7.13601 34.3989 6.61312L35.6952 7.52097C35.7896 7.58983 35.8968 7.63918 36.0105 7.66613C36.1242 7.69307 36.2422 7.69707 36.3574 7.6779C36.4727 7.65872 36.583 7.61675 36.6819 7.55444C36.7807 7.49214 36.8661 7.41074 36.9332 7.31502C37.0002 7.2193 37.0475 7.11118 37.0722 6.99698C37.0969 6.88277 37.0986 6.76478 37.0772 6.64991C37.0558 6.53503 37.0117 6.42558 36.9475 6.32795C36.8833 6.23032 36.8003 6.14648 36.7033 6.08132L34.7752 4.73132ZM44.4949 15.8024L43.632 17.0346C43.4983 17.2255 43.4459 17.4618 43.4864 17.6913C43.5268 17.9209 43.6567 18.125 43.8476 18.2587C43.9951 18.3622 44.171 18.4177 44.3512 18.4175C44.4926 18.4178 44.632 18.3838 44.7575 18.3185C44.8829 18.2532 44.9907 18.1585 45.0717 18.0425L46.353 16.2135C46.4867 16.0225 46.539 15.7863 46.4986 15.5568C46.4582 15.3272 46.3282 15.1231 46.1374 14.9893C45.7345 14.7074 45.6361 14.1503 45.9186 13.747C45.9254 13.7374 45.9318 13.7278 45.9397 13.719C46.0184 13.6257 46.0769 13.5169 46.1113 13.3998C46.1457 13.2826 46.1554 13.1595 46.1396 13.0384C46.124 12.9172 46.0833 12.8007 46.0201 12.6961C45.9569 12.5916 45.8726 12.5014 45.7725 12.4314L43.8443 11.0814C43.6534 10.9477 43.4171 10.8954 43.1876 10.9359C42.958 10.9764 42.754 11.1065 42.6203 11.2975C42.3415 11.
                                            d="M24.9776 48.5028H23.4785C23.2661 48.5025 23.0625 48.418 22.9124 48.2679C22.7622 48.1177 22.6777 47.9141 22.6775 47.7018C22.6777 47.4894 22.7622 47.2858 22.9123 47.1356C23.0625 46.9854 23.2661 46.9009 23.4785 46.9007H26.3472C26.8326 46.9007 27.2261 46.5069 27.2261 46.0218C27.2261 45.5366 26.8326 45.1429 26.3472 45.1429H25.2684V44.3999C25.2684 43.9147 24.8746 43.521 24.3895 43.521C23.9043 43.521 23.5106 43.9147 23.5106 44.3999V45.1429H23.4785C22.0676 45.1429 20.9197 46.291 20.9197 47.7018C20.9197 49.1126 22.0676 50.2607 23.4785 50.2607H24.9776C25.1899 50.2608 25.3935 50.3452 25.5436 50.4954C25.6937 50.6455 25.7781 50.849 25.7783 51.0613C25.7783 51.5031 25.4194 51.8624 24.9776 51.8624H22.1089C21.6232 51.8624 21.23 52.256 21.23 52.7413C21.23 53.2266 21.6232 53.6202 22.1089 53.6202H23.5105V54.3632C23.5105 54.5963 23.6031 54.8198 23.7679 54.9847C23.9327 55.1495 24.1563 55.2421 24.3894 55.2421C24.6225 55.2421 24.846 55.1495 25.0108 54.9847C25.1757 54.8198 25.2683 54.5963 25.2683 54.3632V53.6037C26.5428 53.4586 27.5366 52.3742 27.5366 51.0613C27.5361 49.6504 26.3885 48.5028 24.9776 48.5028Z"/>
                                    </svg>
                                </div>
                                <div class="number">
                                    <span>STEP 04</span>
    ...
    <!-- End Home1 Process section -->

    <!-- Start logo section -->
    <div class="logo-section mb-110">
        <div class="logo-wrap">
            <div class="container">
                <div class="logo-title wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        ...
                        <div class="contact-address-area">
                            ...
                            <div class="contact-area">
                                ...
                                <div class="content">
                                    ...
                                    <h5><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#1a73747c755a7d777b737634797577"><span class="__cf_email__" data-cfemail="ef86818980af88828e8683c18c8082">[email&#160;protected]</span></a></h5>
                                </div>
                            </div>
                        </div>
    ...
    <div class="home1-tetimonial-section mb-110">
                                        ...
                                        <div class="testimonial-content-wrap">
                                            <div class="quote">
                                                <svg width="46" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45.95 40.52">
                                                    <g class="cls-1">
                                                        <path class="cls-2"
                                                              d="M30.66,42.72a7.18,7.18,0,0,0,.75-.31c.38-.17.83-.4,1.31-.64,1-.5,2-1.08,2.58-1.48m3.8-3.09a21.39,21.39,0,0,1-3.8,3.09M45.48,11c0,3.92,0,7.48-.07,8.74"
                                                              transform="translate(-0.04 -2.74)" />
                                                        <path class="cls-2"
                                                              d="M45.48,11l-.07,8.74a35.52,35.52,0,0,1-1.7,10.46,18.56,18.56,0,0,1-4.61,7l-3.8,3.09-4.64,2.43a2.09,2.09,0,0,1-1.14-.1,1.43,1.43,0,0,1-.31-.17,1.47,1.47,0,0,1-.29-.33A22,22,0,0,1,27.81,40c-.48-1-.74-1.56-.88-1.91a2,2,0,0,1-.18-.7,1.46,1.46,0,0,1,.4-1.24h0l0,0,.11-.08.34-.21c.28-.17.63-.36,1-.54s.95-.5,1.39-.77A13.62,13.62,0,0,0,33.17,32a12.1,12.1,0,0,0,2.57-4.48h0a17.94,17.94,0,0,0,.88-5.12V21.24H28.81l-.36-.18a2.1,2.1,0,0,1-.57-.42h0s0,0,0,0a.91.91,0,0,1-.22-.32,3.43,3.43,0,0,1-.13-.92c-.06-1-.05-3,0-7V12l0-7.55.14-.25a2.12,2.12,0,0,1,.44-.55,1.7,1.7,0,0,1,.53-.34l.36,0,1.27,0c1.2,0,3.15,0,6.33,0h7.64l.26.14a2.26,2.26,0,0,1,.88.88h0a3.64,3.64,0,0,1,.09,1.05C45.46,6.24,45.47,7.89,45.48,11Z"
                                                              transform="translate(-0.04 -2.74)" />
                                                        <path class="cls-2"
                                                              d="M19.22,12.22c0,4.09,0,6.4-.07,8a36,36,0,0,1-.34,4.1,27,27,0,0,1-1.37,6h0C15.46,35.46,11,39.86,5,42.46a1.82,1.82,0,0,1-2.25-.31l0,0a1.81,1.81,0,0,0-.1-.17c-.08-.14-.18-.33-.29-.55-.24-.44-.52-1-.8-1.59C1,38.72.77,38.21.65,37.89a1.23,1.23,0,0,1-.09-.32,2.5,2.5,0,0,1,0-.33,1.39,1.39,0,0,1,.28-1,4.53,4.53,0,0,1,1.46-.92,15.9,15.9,0,0,0,4-2.64,11.41,11.41,0,0,0,2.54-3.5,14.26,14.26,0,0,0,1.2-3.62c.09-.46.19-1.2.28-1.9s.14-1.4.14-1.76a.61.61,0,0,0-.08-.31.67.67,0,0,0-.32-.26,2.32,2.32,0,0,0-.58-.08c-.49,0-1.44,0-3.24,0H2.58l-.36-.18h0a2,2,0,0,1-.56-.42h0l0,0a1,1,0,0,1-.21-.32,3.43,3.43,0,0,1-.13-.92c-.06-1-.06-3,0-7V12c0-3.83,0-5.74,0-6.74,0-.5,0-.75.06-.88a.31.31,0,0,1,0-.17h0a2,2,0,0,1,.89-.85.81.81,0,0,1,.22-.07c.15,0,.41,0,.93-.05,1,0,3,0,6.86,0H18l.26.14a2,2,0,0,1,.86.86h0a4,4,0,0,1,.09,1.17C19.22,6.48,19.22,8.45,19.22,12.22Z"
                                                              transform="translate(-0.04 -2.74)" />
                                                    </g>
                                                </svg>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="blog-card">
                        ...
                        <div class="card-content">
                            ...
                            <h4><a href="blog-details.html">Exploring the hrils tales and trends in the world of auctions.</a></h4>
                            <a class="view-button" href="blog-details.html">
                                Read More
                                <svg viewBox="0 0 13 20">
                                    <polyline points="0.5 19.5 3 19.5 12.5 10 3 0.5"></polyline>
                                </svg>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="blog-card">
                        ...
                        <div class="card-content">
                            ...
                            <h4><a href="blog-details.html">Collectibles, collectibles, art, and uncover the fascinating.</a></h4>
                            <a class="view-button" href="blog-details.html">
                                Read More
                                <svg viewBox="0 0 13 20">
                                    <polyline points="0.5 19.5 3 19.5 12.5 10 3 0.5"></polyline>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="blog-card">
                        ...
                        <div class="card-content">
                            <div class="blog-meta">
                                <ul class="category">
                                    <li><a href="blog-grid.html">BOOKS & COMICS</a></li>
                                </ul>
                                <div class="blog-comment">
                                    <span>Comment (25)</span>
                                </div>
                            </div>
                            <h4><a href="blog-details.html">Bidding chronicles unveling behind stories remarkable.</a></h4>
                            <a class="view-button" href="blog-details.html">
                                Read More
                                <svg viewBox="0 0 13 20">
                                    <polyline points="0.5 19.5 3 19.5 12.5 10 3 0.5"></polyline>
