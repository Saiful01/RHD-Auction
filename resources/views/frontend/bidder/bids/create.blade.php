    ...
    <div class="container">
        ...
        <div class="card mb-4 shadow-sm p-3">
            ...
            <div class="form-check mt-3">
                <input type="checkbox" class="form-check-input" id="is_condition_accept" name="is_condition_accept" value="1" required>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" min="0" step="0.01"
                                    name="bids[{{ $item->id }}]" class="form-control unit-price-input" required>
                            </td>
