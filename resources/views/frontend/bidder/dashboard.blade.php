                            ...
                            <a href="dashboard-payment.html">
                                <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        ...
                                        <path
                                            d="M13.908 10.6367C13.457 10.6367 13.0898 11.0039 13.0898 11.4549C13.0898 11.9059 13.457 12.273 13.908 12.273C14.359 12.273 14.7262 11.9059 14.7262 11.4549C14.7262 11.0039 14.3591 10.6367 13.908 10.6367Z" />
                                    </g>
                                </svg>
                                <h6>Payment</h6>
                            </a>
                ...
                <div class="dashboard-content-wrap">
                    <div class="profile-info-wrap">
                        <div class="profile-img">
                            <img src="{{ asset('storage/' . $bidder->photo) }}" alt="">
                        </div>
